"""
Django settings for test_push_notificat_36196 project.
...
ROOT_URLCONF = 'test_push_notificat_36196.urls'
...
WSGI_APPLICATION = 'test_push_notificat_36196.wsgi.application'
