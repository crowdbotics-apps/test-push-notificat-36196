...
## Project Structure
    ...
    ├── test_push_notificat_36196  # Django project configurations
...
1. Clone this repo and `cd test_push_notificat_36196`
...
2. Clone this repo and `cd test_push_notificat_36196`
